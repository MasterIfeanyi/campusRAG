...
export default function CreatePost() {
  ...
  return (
    <div className="py-1 px-6">
      ...
      <div className="border border-border rounded-2xl p-6 flex flex-col min-h-[500px]">
        <Input
          id="post-title"
          value={title}
          ...
          placeholder="Title"
          bare
          className="text-lg font-medium text-foreground placeholder:text-muted-foreground"
        />
        ...
        <TextArea
          ...
          rows={12}
          className="flex-1 border-0 focus:ring-0 px-0 resize-none mt-2"
        />

        <div className="flex items-center justify-between mt-4">
          {/* Three-dot tag menu goes here, step 3 */}
          <Button
            bare
